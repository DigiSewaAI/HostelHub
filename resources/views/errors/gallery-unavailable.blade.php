...
@section('page-title', 'Gallery Unavailable | HostelHub')
...
<div class="container mx-auto py-20 px-4 text-center">
    <div class="max-w-md mx-auto">
        ...
        <div class="space-y-4">
            <a href="{{ url('/') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl px-6 py-3 nepali inline-block">
                होमपेजमा फर्कनुहोस्
            </a>
            <br>
