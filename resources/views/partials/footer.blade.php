  ...
  <div class="max-w-7xl mx-auto px-4 py-10 grid md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <ul class="mt-3 space-y-2 text-sm">
        ...
        <li><a href="{{ route('features') }}">सुविधाहरू</a></li>
        <li><a href="{{ route('how-it-works') }}">कसरी काम गर्छ</a></li>
        <li><a href="{{ route('pricing') }}">मूल्य</a></li>
        <li><a href="{{ route('gallery.public') }}">ग्यालरी</a></li>
      </ul>
    </div>
    <div>
    ...
    <div>
      ...
      <ul class="mt-3 space-y-2 text-sm">
        <li><a href="{{ route('privacy') }}">गोपनीयता नीति</a></li>
        <li><a href="{{ route('terms') }}">सर्तहरू</a></li>
        <li><a href="{{ route('cookies') }}">कुकीज</a></li>
      </ul>
    </div>
  </div>
  <div class="border-t border-gray-800">
    <div class="max-w-7xl mx-auto px-4 py-4 text-xs text-gray-400">
      © {{ now()->year }} HostelHub. सबै अधिकार सुरक्षित।
    </div>
  </div>
</footer>