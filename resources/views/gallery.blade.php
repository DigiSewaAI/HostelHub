            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="relative group">
                        <img src="{{ asset('storage/hostel/single-room.jpg') }}"
                             alt="एकल कोठा"
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="relative group">
                        <img src="{{ asset('storage/hostel/double-room.jpg') }}"
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="relative group">
                        <video class="w-full h-64 object-cover"
                               poster="{{ asset('storage/hostel/video-tour-thumbnail.jpg') }}"
                               muted>
                            <source src="{{ asset('storage/hostel/hostel-tour.mp4') }}" type="video/mp4">
                            <source src="{{ asset('storage/hostel/hostel-tour.webm') }}" type="video/webm">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-colors play-video-btn"
                                    data-video="{{ asset('storage/hostel/hostel-tour.mp4') }}"
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="relative group">
                        <img src="{{ asset('storage/hostel/dining-hall.jpg') }}"
                             alt="भोजन कक्ष"
                             class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute bottom-4 left-4">
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="relative group">
                        <img src="{{ asset('storage/hostel/study-area.jpg') }}"
                             alt="अध्ययन क्षेत्र"
                             class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute bottom-4 left-4">
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                     data-category="common">
                    <div class="relative group">
                        <img src="{{ asset('storage/hostel/living-room.jpg') }}"
                             alt="लिभिङ रूम"
                             class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute bottom-4 left-4">
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                     data-category="common">
                    <div class="relative group">
                        <img src="{{ asset('storage/hostel/bathroom.jpg') }}"
                             alt="बाथरूम"
                             class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute bottom-4 left-4">
                ...
                <div class="gallery-item bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl"
                    ...
                    <div class="relative group">
                        <video class="w-full h-64 object-cover"
                               poster="{{ asset('storage/hostel/study-area-video.jpg') }}"
                               muted>
                            <source src="{{ asset('storage/hostel/study-area-tour.mp4') }}" type="video/mp4">
                            <source src="{{ asset('storage/hostel/study-area-tour.webm') }}" type="video/webm">
                            तपाईंको ब्राउजरले भिडियो समर्थन गर्दैन
                        </video>
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute inset-0 flex items-center justify-center">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-red-500 font-semibold">काठमाडौं होस्टल</span>
                            <button class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-colors play-video-btn"
                                    data-video="{{ asset('storage/hostel/study-area-tour.mp4') }}"
