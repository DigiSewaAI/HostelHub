...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{ route('network.broadcast.index') }}">{{ __('network.broadcast') }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">{{ __('network.create_broadcast') }}</li>
@endsection
