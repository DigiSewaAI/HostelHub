...
<body class="bg-gray-50 font-sans">
    ...
    <nav class="nav-container">
        <div class="flex items-center">
            <a href="{{ route('student.dashboard') }}" class="flex items-center text-decoration-none">
                ...
                <main id="main-content">
                    ...
                    @else
                        ...
                        <div class="button-container">
                            <a href="{{ route('student.hostel.search') }}" class="btn btn-primary">
                                <i class="fas fa-search me-2"></i>होस्टल खोज्नुहोस्
                            </a>
                            <a href="{{ route('student.hostel.join') }}" class="btn btn-success">
