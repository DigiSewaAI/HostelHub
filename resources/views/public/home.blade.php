        ...
        <div class="container">
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-count count-up" id="students-counter-stat">125</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-count count-up" id="hostels-counter-stat">24</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-count count-up" id="cities-counter-stat">5</div>
        ...
        <div class="container">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    ...
                    <h3 class="feature-title nepali">विश्लेषण र रिपोर्ट</h3>
                ...
                <div class="feature-card">
                    ...
                    <h3 class="feature-title nepali">मोबाइल एप्प</h3>
    ...
    <section class="section gallery" id="gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                ...
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="लिभिङ रूम" data-caption="लिभिङ रूम">
                    <div class="gallery-overlay"></div>
                    <div class="gallery-caption nepali">लिभिङ रूम</div>
                </div>
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1584036561566-baf9516e802f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="बाथरूम" data-caption="बाथरूम">
                    <div class="gallery-overlay"></div>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                <div class="pricing-card">
                    ...
                    <a href="/signup" class="btn btn-outline nepali">सुरु गर्नुहोस्</a>
                </div>
