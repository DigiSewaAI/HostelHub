...
@section('title', 'समीक्षामा जवाफ सम्पादन गर्नुहोस्')
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('owner.reviews.show', $review) }}" class="text-indigo-600 hover:text-indigo-900 flex items-center">
        ...
        <form action="{{ route('owner.reviews.updateReply', $review) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea name="reply" id="reply" rows="5" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" 
                          placeholder="तपाईंको जवाफ यहाँ लेख्नुहोस्..." required>{{ old('reply', $review->reply) }}</textarea>
                @error('reply')
