...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <span class="badge badge-primary badge-pill">{{ $pendingBookings->total() }} पेन्डिङ</span>
    </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card border-left-warning shadow h-100">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-warning">बुकिंग #{{ $booking->id }}</h6>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="btn-group" role="group">
                                <form action="{{ route('owner.bookings.approve', $booking->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" class="btn btn-success btn-sm">
                                        <i class="fas fa-check"></i> स्वीकृत गर्नुहोस्
                                    </button>
                                </form>
                                <form action="{{ route('owner.bookings.reject', $booking->id) }}" method="POST" class="d-inline">
                                    @csrf
