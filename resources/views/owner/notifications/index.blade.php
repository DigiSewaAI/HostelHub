...
<div class="container-fluid px-4 py-4">
    <div class="flex justify-between items-center mb-6">
        ...
        <form action="{{ route('owner.notifications.mark-all-read') }}" method="POST">
            @csrf
            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">समीक्षा ID: {{ $data['review_id'] }}</p>
                                @endif
                            </div>
                        </div>
                    </td>
