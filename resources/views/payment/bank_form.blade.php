...
@section('title', 'बैंक हस्तान्तरण विवरण')
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <strong class="nepali">बैंक:</strong> {{ $bankDetails['bank_name'] }}<br>
                                <strong class="nepali">खाता नम्बर:</strong> {{ $bankDetails['account_number'] }}<br>
                                <strong class="nepali">खाता धनी:</strong> {{ $bankDetails['account_name'] }}
                            </div>
                            <div class="col-md-6">
                                @if($bankDetails['branch'])
                                <strong class="nepali">शाखा:</strong> {{ $bankDetails['branch'] }}<br>
                                @endif
                                <strong class="nepali">रकम:</strong> रु {{ number_format($amount, 2) }}
                            </div>
                        </div>
                    </div>

                    <form action="{{ route('payment.bank.request') }}" method="POST" enctype="multipart/form-data">
                        @csrf
