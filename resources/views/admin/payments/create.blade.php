    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4 nepali">नयाँ भुक्तानी थप्नुहोस्</h2>
                <a href="{{ route('admin.payments.index') }}" class="btn btn-secondary nepali">
            ...
            <div class="card shadow">
                <div class="card-header bg-white nepali">
                    <h5 class="mb-0">भुक्तानी विवरण</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.payments.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="payment_method" class="form-select nepali @error('payment_method') is-invalid @enderror" required>
                                        ...
                                        <option value="bank" {{ old('payment_method') == 'bank' ? 'selected' : '' }}>बैंक हस्तान्तरण</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-select nepali @error('status') is-invalid @enderror" required>
                                        <option value="completed" {{ old('status') == 'completed' ? 'selected' : '' }}>पूर्ण</option>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit" class="btn btn-primary nepali px-4">
                                <i class="fas fa-save me-2"></i> भुक्तानी सुरक्षित गर्नुहोस्
                            </button>
                        </div>
                    </form>
                </div>
