...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('admin.bookings.pending') }}" class="btn btn-warning btn-sm me-2 nepali">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select nepali" name="status">
                            ...
                            <option value="cancelled" {{ request('status') == 'cancelled' ? 'selected' : '' }}>रद्द भएको</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="d-grid gap-2 w-100">
                            ...
                            <a href="{{ route('admin.bookings.index') }}" class="btn btn-outline-secondary nepali">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-success">रु {{ number_format($booking->room->price_per_semester, 2) }}</td>
                            <td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="nepali">बुकिंग #{{ $booking->id }} लाई अस्वीकृत गर्नुहुन्छ?</p>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="nepali">
                    देखाइरहेको छ {{ $bookings->firstItem() }} देखि {{ $bookings->lastItem() }} सम्म, कुल {{ $bookings->total() }} मध्ये
                </div>
                <div>
                    {{ $bookings->links() }}
                </div>
