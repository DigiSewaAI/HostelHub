    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <!-- खोज फार्म -->
                    <form action="{{ route('admin.documents.search') }}" method="GET" class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label for="student_name" class="form-label">विद्यार्थीको नाम</label>
                                <input type="text" name="student_name" id="student_name" 
                                       class="form-control" value="{{ request('student_name') }}"
                    ...
                    @if(isset($results))
                        @if($results->count() > 0)
                            <div class="alert alert-success">
                                ...
                                {{ $results->count() }} वटा कागजातहरू भेटिए
                            </div>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $document->student->user->name ?? 'उपलब्ध छैन' }}</td>
                                            <td>
