...
<head>
    ...
    <title>{{ $room->room_number }} - विवरण</title>
        ...
        <div class="room-detail">
            ...
            <div class="room-info">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ $room->capacity }} जनासम्म बस्न सकिने</div>
                </div>
                <div class="info-row">
                    <div class="info-label">हालको भर</div>
                    <div class="info-value">{{ $room->students_count }} जना</div>
                </div>
                <div class="info-row">
                    <div class="info-label">उपलब्ध क्षमता</div>
                    <div class="info-value">{{ $room->available_capacity }} जना</div>
                </div>
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <span class="badge 
                            ...
                            {{ $room->status == 'available' ? 'उपलब्ध' : ($room->status == 'occupied' ? 'प्रयोगमा' : 'मर्मतको लागि') }}
                        </span>
                    </div>
                </div>
                <div class="info-row">
                    <div class="info-label">विवरण</div>
                    <div class="info-value">{{ $room->description ?? 'विवरण उपलब्ध छैन।' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">फ्लोर</div>
                    <div class="info-value">{{ $room->floor ?? 'उल्लेख गरिएको छैन' }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">होस्टल</div>
                    <div class="info-value">{{ $room->hostel->name ?? 'निर्धारित छैन' }}</div>
                </div>

                <a href="#" class="btn-primary">अहिले बुक गर्नुहोस्</a>
                <a href="{{ route('public.rooms') }}" class="btn-secondary">पछाडि जानुहोस्</a>
            </div>
        </div>
    </div>
