...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">विद्यार्थी सम्पादन: <?php echo e($student->user->name); ?></h1>
    ...
    <form action="<?php echo e(route('admin.students.update', $student->id)); ?>" method="POST" class="bg-white shadow-md rounded-lg p-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="college" value="<?php echo e(old('college', $student->college)); ?>"
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="guardian_name" value="<?php echo e(old('guardian_name', $student->guardian_name)); ?>"
                           class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-300" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="guardian_phone" value="<?php echo e(old('guardian_phone', $student->guardian_phone)); ?>"
                           class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-300" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="guardian_relation" value="<?php echo e(old('guardian_relation', $student->guardian_relation)); ?>"
                           class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-300" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="admission_date" value="<?php echo e(old('admission_date', $student->admission_date ? $student->admission_date->format('Y-m-d') : '')); ?>"
                           class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-300" required>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views\admin\students\edit.blade.php ENDPATH**/ ?>