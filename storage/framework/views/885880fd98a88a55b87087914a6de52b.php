        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border-l-4 border-blue-500">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($todayCirculars ?? 0); ?></p>
                </div>
                <div class="bg-blue-100 p-3 rounded-xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border-l-4 border-green-500">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($circularReadRate ?? 0); ?>%</p>
                </div>
                <div class="bg-green-100 p-3 rounded-xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border-l-4 border-purple-500">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($studentEngagement ?? 0); ?>%</p>
                </div>
                <div class="bg-purple-100 p-3 rounded-xl">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\owner\dashboard.blade.php ENDPATH**/ ?>