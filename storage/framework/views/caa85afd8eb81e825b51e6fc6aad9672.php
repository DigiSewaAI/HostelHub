<?php $__env->startSection('title', 'नयाँ होस्टल सिर्जना गर्नुहोस्'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.hostels.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="contact_person" name="contact_person" value="<?php echo e(old('contact_person')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="contact_phone" name="contact_phone" value="<?php echo e(old('contact_phone')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                                        ...
                                        <option value="under_maintenance" <?php echo e(old('status') == 'under_maintenance' ? 'selected' : ''); ?>>मर्मतमा</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                           id="total_rooms" name="total_rooms" value="<?php echo e(old('total_rooms', 0)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="available_rooms" name="available_rooms" value="<?php echo e(old('available_rooms', 0)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="price_per_month" name="price_per_month" value="<?php echo e(old('price_per_month')); ?>" min="0" step="0.01">
...
unset($__errorArgs, $__bag); ?>"
                                      id="facilities" name="facilities" rows="2" placeholder="वाइफाइ, लन्ड्री, तातो पानी, सीसीटीभी"><?php echo e(old('facilities')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\admin\hostels\create.blade.php ENDPATH**/ ?>