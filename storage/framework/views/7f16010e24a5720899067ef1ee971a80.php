...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-blue-500 hover:underline text-sm">
                            Forgot Password?
                        </a>
                    <?php endif; ?>
                </div>
...
<?php /**PATH D:\My Projects\HostelHub\resources\views\auth\confirm-password.blade.php ENDPATH**/ ?>