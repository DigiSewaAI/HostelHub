                        ...
                        <table class="table table-hover table-striped align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="mailto:<?php echo e($submission->email); ?>" class="text-decoration-none"><?php echo e($submission->email); ?></a></td>
                                    <td><?php echo e($submission->phone ?? '—'); ?></td>
                                    <td><?php echo e(Str::limit($submission->subject, 30)); ?></td>
                                    <td>
                                        <?php if($submission->status == 'नयाँ'): ?>
                                            <span class="badge bg-warning text-dark">नयाँ</span>
                                        <?php elseif($submission->status == 'पढियो'): ?>
                                            <span class="badge bg-info">पढियो</span>
                                        <?php elseif($submission->status == 'जवाफ दिइयो'): ?>
                                            <span class="badge bg-success">जवाफ दिइयो</span>
                                        <?php else: ?>
                                            <span class="badge bg-secondary"><?php echo e($submission->status); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-center">
                                        <a href="<?php echo e(route('admin.contacts.show', $submission->id)); ?>" class="btn btn-info btn-sm me-1" title="सन्देश हेर्नुहोस्">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.contacts.edit', $submission->id)); ?>" class="btn btn-primary btn-sm me-1" title="सम्पादन गर्नुहोस्">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="<?php echo e(route('admin.contacts.destroy', $submission->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views/admin/contacts/index.blade.php ENDPATH**/ ?>