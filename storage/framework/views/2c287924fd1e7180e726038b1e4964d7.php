...
<style>
    :root {
        --theme-color: <?php echo e($hostel->theme_color ?? '#8B4513'); ?>;
        --primary-color: <?php echo e($hostel->theme_color ?? '#8B4513'); ?>;
        --gold-color: #D4AF37;
        --dark-brown: #654321;
        --cream-color: #F5F5DC;
        --light-beige: #F8F4E9;
...
<div class="classic-body">
        ...
        <div class="classic-main-container">
            ...
            <div class="classic-header-content">
                ...
                <div class="classic-title">
                    <h1 class="nepali-font"><?php echo e($hostel->name); ?></h1>
                    <?php if($hostel->city): ?>
                    <div class="location nepali-font">
                        <i class="fas fa-map-marker-alt mr-1"></i><?php echo e($hostel->city); ?>
                    ...
                    <div style="background: rgba(255,255,255,0.9); padding: 0.6rem 1.5rem; border-radius: 25px; display: inline-block;">
                        <div style="color: var(--gold-color); margin-bottom: 0.3rem;">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <i class="fas fa-star <?php echo e($i <= round($avgRating) ? '' : 'text-gray-300'); ?>"></i>
                            <?php endfor; ?>
                        </div>
            ...
            <div class="classic-stats">
                <div class="classic-stat-item">
                    <span class="classic-stat-number"><?php echo e($hostel->total_rooms ?? 0); ?></span>
                    <span class="classic-stat-label nepali-font">कुल कोठा</span>
                </div>
                <div class="classic-stat-item">
                    <span class="classic-stat-number"><?php echo e($hostel->available_rooms ?? 0); ?></span>
                    <span class="classic-stat-label nepali-font">उपलब्ध कोठा</span>
                </div>
                <div class="classic-stat-item">
                    <span class="classic-stat-number"><?php echo e($studentCount); ?></span>
                    <span class="classic-stat-label nepali-font">विद्यार्थी</span>
                </div>
                <div class="classic-stat-item">
                    <span class="classic-stat-number"><?php echo e($reviewCount); ?></span>
            ...
            <div class="classic-social-container">
                ...
                <div class="classic-social-buttons">
                    <?php if($hostel->facebook_url): ?>
                        <a href="<?php echo e($hostel->facebook_url); ?>" target="_blank" class="classic-social-btn" style="background: #1877f2;">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                    <?php endif; ?>
                    <?php if($hostel->instagram_url): ?>
                        <a href="<?php echo e($hostel->instagram_url); ?>" target="_blank" class="classic-social-btn" style="background: #e4405f;">
                            <i class="fab fa-instagram"></i>
                        </a>
                    <?php endif; ?>
                    <?php if($hostel->whatsapp_number): ?>
                        <a href="https://wa.me/<?php echo e($hostel->whatsapp_number); ?>" target="_blank" class="classic-social-btn" style="background: #25d366;">
    ...
    <div class="classic-main-container">
        ...
        <div class="classic-action-buttons">
            ...
            <a href="tel:<?php echo e($hostel->contact_phone); ?>" class="classic-action-btn classic-phone-btn">
                <i class="fas fa-phone"></i>
                <span class="nepali-font">फोन गर्नुहोस्</span>
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('hostels.index')); ?>" class="classic-action-btn">
            ...
            <div class="classic-facilities-grid">
                <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="classic-facility-item">
                        ...
                        <span class="nepali-font" style="font-size: 1rem; font-weight: 500;"><?php echo e(trim($facility)); ?></span>
                    </div>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                ...
                <div>
                    ...
                    <div class="classic-review-item">
                        <div class="classic-review-header">
                            <div class="classic-reviewer nepali-font"><?php echo e($review->student->user->name ?? 'अज्ञात विद्यार्थी'); ?></div>
                            <div class="classic-review-date"><?php echo e($review->created_at->format('Y-m-d')); ?></div>
                        </div>
                        <div class="classic-review-rating">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <i class="fas fa-star <?php echo e($i <= $review->rating ? '' : 'text-gray-300'); ?>"></i>
                            <?php endfor; ?>
                            <span style="color: var(--deep-red); font-weight: bold; margin-left: 0.8rem;"><?php echo e($review->rating); ?>/5</span>
                        </div>
                        <div class="classic-review-content nepali-font"><?php echo e($review->comment); ?></div>
                        ...
                        <div style="background: rgba(212, 175, 55, 0.1); border-left: 4px solid var(--gold-color); padding: 1rem; margin-top: 1rem; border-radius: 8px;">
                            <div style="display: flex; align-items: start; gap: 0.8rem;">
                                ...
                                <div>
                                    ...
                                    <p style="color: #5C4033; margin-top: 0.5rem; font-size: 0.9rem;" class="nepali-font"><?php echo e($review->reply); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
        ...
        <section class="classic-section">
            ...
            <div class="classic-contact-grid">
                ...
                <div class="classic-contact-item">
                    ...
                    <p class="nepali-font" style="font-size: 0.9rem; font-weight: 500;"><?php echo e($hostel->contact_person); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="classic-contact-item">
                    ...
                    <a href="tel:<?php echo e($hostel->contact_phone); ?>" style="font-size: 0.9rem; font-weight: 500; color: var(--dark-brown); text-decoration: none;">
                ...
                <div class="classic-contact-item">
                    ...
                    <a href="mailto:<?php echo e($hostel->contact_email); ?>" style="font-size: 0.9rem; font-weight: 500; color: var(--dark-brown); text-decoration: none;">
                ...
                <div class="classic-contact-item">
                    ...
                    <p class="nepali-font" style="font-size: 0.9rem; font-weight: 500;"><?php echo e($hostel->address); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\public\hostels\themes\classic.blade.php ENDPATH**/ ?>