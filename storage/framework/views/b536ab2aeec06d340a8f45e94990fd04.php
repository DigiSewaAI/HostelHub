...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="स्ट्यान्डर्ड" <?php echo e(old('type') == 'स्ट्यान्डर्ड' ? 'selected' : ''); ?>>स्ट्यान्डर्ड</option>
                                <option value="डीलक्स" <?php echo e(old('type') == 'डीलक्स' ? 'selected' : ''); ?>>डीलक्स</option>
                                <option value="विआईपी" <?php echo e(old('type') == 'विआईपी' ? 'selected' : ''); ?>>विआईपी</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="उपलब्ध" <?php echo e(old('status', 'उपलब्ध') == 'उपलब्ध' ? 'selected' : ''); ?>>उपलब्ध</option>
                                <option value="बुक भएको" <?php echo e(old('status') == 'बुक भएको' ? 'selected' : ''); ?>>बुक भएको</option>
                                <option value="रिङ्गोट" <?php echo e(old('status') == 'रिङ्गोट' ? 'selected' : ''); ?>>रिङ्गोट</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="floor" id="floor" class="form-control <?php $__errorArgs = ['floor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
