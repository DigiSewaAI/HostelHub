<?php $__env->startSection('title', 'समीक्षामा जवाफ दिनुहोस्'); ?>
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <form action="<?php echo e(route('owner.reviews.storeReply', $review)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <textarea name="reply" id="reply" rows="5" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" 
                          placeholder="तपाईंको जवाफ यहाँ लेख्नुहोस्..." required><?php echo e(old('reply')); ?></textarea>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views\owner\reviews\create.blade.php ENDPATH**/ ?>