...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="position" id="position" class="form-control <?php $__errorArgs = ['position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="5" required><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="initials" id="initials" class="form-control <?php $__errorArgs = ['initials'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('initials')); ?>" maxlength="10" placeholder="जस्तै: RS, JP, आदि">
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="testimonial" <?php echo e(old('type') == 'testimonial' ? 'selected' : ''); ?>>प्रशंसापत्र</option>
                                    <option value="review" <?php echo e(old('type') == 'review' ? 'selected' : ''); ?>>समीक्षा</option>
                                    <option value="feedback" <?php echo e(old('type') == 'feedback' ? 'selected' : ''); ?>>प्रतिक्रिया</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="1" <?php echo e(old('rating') == 1 ? 'selected' : ''); ?>>१ - धेरै नराम्रो</option>
                                <option value="2" <?php echo e(old('rating') == 2 ? 'selected' : ''); ?>>२ - नराम्रो</option>
                                <option value="3" <?php echo e(old('rating') == 3 ? 'selected' : ''); ?>>३ - सामान्य</option>
                                <option value="4" <?php echo e(old('rating') == 4 ? 'selected' : ''); ?>>४ - राम्रो</option>
                                <option value="5" <?php echo e(old('rating') == 5 ? 'selected' : ''); ?>>५ - धेरै राम्रो</option>
                            </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views\reviews\create.blade.php ENDPATH**/ ?>