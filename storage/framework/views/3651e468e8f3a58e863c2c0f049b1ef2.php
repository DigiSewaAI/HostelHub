<?php $__env->startSection('title', 'कोठा उपलब्धता व्यवस्थापन: ' . $hostel->name); ?>
        ...
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-header bg-white py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><?php echo e($hostel->name); ?> को लागि कोठा उपलब्धता व्यवस्थापन</h6>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card bg-light">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="text-primary"><?php echo e($hostel->rooms->count()); ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card bg-success text-white">
                                <div class="card-body text-center">
                                    ...
                                    <h3><?php echo e($hostel->rooms->where('status', 'available')->count()); ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card bg-danger text-white">
                                <div class="card-body text-center">
                                    ...
                                    <h3><?php echo e($hostel->rooms->where('status', 'occupied')->count()); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>

                    <form action="<?php echo e(route('admin.hostels.availability.update', $hostel)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <table class="table table-hover" id="roomsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($room->students_count); ?> / <?php echo e($room->capacity); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <select name="rooms[<?php echo e($room->id); ?>][status]" class="form-select room-status">
                                                <option value="available" <?php echo e($room->status === 'available' ? 'selected' : ''); ?>>उपलब्ध</option>
                                                <option value="occupied" <?php echo e($room->status === 'occupied' ? 'selected' : ''); ?>>अधिभृत</option>
                                                <option value="maintenance" <?php echo e($room->status === 'maintenance' ? 'selected' : ''); ?>>मर्मतमा</option>
                                            </select>
                                        </td>
                                        <td>
                                            <input type="text" 
                                                   name="rooms[<?php echo e($room->id); ?>][notes]" 
                                                   class="form-control form-control-sm" 
                                                   placeholder="वैकल्पिक नोटहरू"
                                                   value="<?php echo e(old('rooms.'.$room->id.'.notes')); ?>">
                                        </td>
                                    </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\admin\hostels\availability.blade.php ENDPATH**/ ?>