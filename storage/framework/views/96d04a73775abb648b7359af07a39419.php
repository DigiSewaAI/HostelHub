...
<head>
    ...
    <?php else: ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('build/assets/app-BA4f1sf9.css')); ?>">
                ...
                <div class="navbar">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="logo">
                        ...
                        <div class="logo-image">
                            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="HostelHub Logo" style="height: 50px; width: auto;" onerror="this.style.display='none'">
                        </div>
                        <div class="logo-text">
                            <h1>HostelHub</h1>
            ...
            <div class="footer-grid">
                <div class="footer-col">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="footer-logo">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="HostelHub Logo" style="height: 40px; width: auto;" onerror="this.style.display='none'">
                        <span>HostelHub</span>
                    </a>
...
</html><?php /**PATH C:\laragon\www\HostelHub\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>