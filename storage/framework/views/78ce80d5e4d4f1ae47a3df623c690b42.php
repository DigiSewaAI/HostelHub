...
<form method="POST" action="<?php echo e(route('onboarding.store', 1)); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="name" id="name" class="form-control" 
                   value="<?php echo e($organization->name); ?>" required>
        </div>
        ...
        <div class="col-md-12 mb-3">
            ...
            <textarea name="address" id="address" class="form-control" rows="2" required><?php echo e($organization->settings['address'] ?? ''); ?></textarea>
        </div>
    ...
    <div class="d-flex justify-content-between mt-4">
        ...
        <button type="button" class="btn btn-outline-secondary px-4" 
                onclick="window.location.href='<?php echo e(route('onboarding.skip', 1)); ?>'">
            यो चरण छोड्नुहोस्
        </button>
    </div>
</form><?php /**PATH C:\laragon\www\HostelHub\resources\views\onboarding\steps\step1.blade.php ENDPATH**/ ?>