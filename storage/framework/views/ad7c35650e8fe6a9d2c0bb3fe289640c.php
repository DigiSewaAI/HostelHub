    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.circulars.update', $circular) }}" method="POST">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="organization_id" id="organization_id" class="form-control">
                                        ...
                                        @foreach($organizations as $organization)
                                            <option value="{{ $organization->id }}" {{ old('organization_id', $circular->organization_id) == $organization->id ? 'selected' : '' }}>
                                                {{ $organization->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="audience_type" id="audience_type" class="form-control" required>
                                        <optgroup label="ग्लोबल लक्ष्यहरू">
                                            <option value="all_students" {{ old('audience_type', $circular->audience_type) == 'all_students' ? 'selected' : '' }}>सबै विद्यार्थीहरू</option>
                                            <option value="all_managers" {{ old('audience_type', $circular->audience_type) == 'all_managers' ? 'selected' : '' }}>सबै होस्टेल म्यानेजरहरू</option>
                                            <option value="all_users" {{ old('audience_type', $circular->audience_type) == 'all_users' ? 'selected' : '' }}>सबै प्रयोगकर्ताहरू</option>
                                        </optgroup>
...
@endpush ?><?php /**PATH D:\My Projects\HostelHub\resources\views\admin\circulars\edit.blade.php ENDPATH**/ ?>