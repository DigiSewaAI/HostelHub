        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">
                        <form id="toggle-status-<?php echo e($item->id); ?>" action="<?php echo e(route('admin.galleries.toggle-status', $item)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <td class="px-6 py-4">
                        <form id="toggle-featured-<?php echo e($item->id); ?>" action="<?php echo e(route('admin.galleries.toggle-featured', $item)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <button type="button" 
