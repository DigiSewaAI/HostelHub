            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-muted">
                        <div class="col-md-6">
                            <small>
                                <strong>संस्था:</strong> 
                                @if($circular->organization)
                                    {{ $circular->organization->name }}
                                @else
                                    ग्लोबल
                                @endif
                            </small><br>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <a href="{{ route('admin.circulars.edit', $circular) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-edit mr-1"></i>सम्पादन गर्नुहोस्
                            </a>
                            <a href="{{ route('admin.circulars.analytics.single', $circular) }}" class="btn btn-warning btn-sm">
                                <i class="fas fa-chart-bar mr-1"></i>विश्लेषण हेर्नुहोस्
                            </a>
                            <form action="{{ route('admin.circulars.destroy', $circular) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.circulars.publish', $circular) }}" method="POST" class="mt-3">
                        @csrf
...
@endsection ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\admin\circulars\show.blade.php ENDPATH**/ ?>