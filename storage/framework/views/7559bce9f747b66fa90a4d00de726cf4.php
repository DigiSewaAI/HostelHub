...
<head>
    ...
    <style>
        .hero-section {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('<?php echo e(asset('images/hero-bg.jpg')); ?>');
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                            लगइन
                        </a>
                        <a href="<?php echo e(route('register.organization')); ?>" class="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">
                            साइन अप
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">
                            ड्यासबोर्ड
                        </a>
                    <?php endif; ?>
                </div>
        ...
        <div class="sm:hidden" id="mobile-menu">
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                <div class="flex items-center px-4">
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-base font-medium text-gray-500 hover:text-gray-900">
                            लगइन
                        </a>
                        <a href="<?php echo e(route('register.organization')); ?>" class="ml-8 bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-base font-medium">
                            साइन अप
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="ml-8 bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-base font-medium">
                            ड्यासबोर्ड
                        </a>
                    <?php endif; ?>
                </div>
