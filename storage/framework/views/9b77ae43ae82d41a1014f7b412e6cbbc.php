        ...
        <div class="flex flex-col md:flex-row justify-between">
            ...
            <div class="mb-6 md:mb-0">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="<?php echo e(route('gallery')); ?>" class="hover:text-blue-200">ग्यालरी</a></li>
                    <li><a href="<?php echo e(route('pricing')); ?>" class="hover:text-blue-200">मूल्य</a></li>
                    <li><a href="<?php echo e(route('testimonials')); ?>" class="hover:text-blue-200">प्रशंसापत्रहरू</a></li> 
                </ul>
            </div>
...
</footer><?php /**PATH C:\laragon\www\HostelHub\resources\views\components\footer.blade.php ENDPATH**/ ?>