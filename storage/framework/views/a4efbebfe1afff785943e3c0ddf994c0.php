        ...
        <aside id="sidebar" class="sidebar text-white z-20 flex-shrink-0 transition-all duration-300 ease-in-out flex flex-col h-full">
            <div class="p-4 border-b border-blue-700 flex items-center justify-between">
                <a href="<?php echo e(url('/owner/dashboard')); ?>" class="logo-container">
                    ...
                    <?php $__currentLoopData = $logoPaths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logoPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(file_exists(public_path($logoPath)) && !$logoFound): ?>
                            <img src="<?php echo e(asset($logoPath)); ?>" alt="HostelHub Logo" class="logo-img">
                            <?php $logoFound = true; ?>
                        <?php endif; ?>
                ...
                <div class="flex items-center justify-between px-6 header-content">
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(url('/owner/dashboard')); ?>" class="navbar-brand text-white flex items-center">
                            ...
                            <?php $__currentLoopData = $logoPaths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logoPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(file_exists(public_path($logoPath)) && !$mobileLogoFound): ?>
                                    <img src="<?php echo e(asset($logoPath)); ?>" alt="HostelHub Logo" class="mobile-logo mr-2">
                                    <?php $mobileLogoFound = true; ?>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            
                            <?php if(!$mobileLogoFound): ?>
...
</html><?php /**PATH C:\laragon\www\HostelHub\resources\views\layouts\student.blade.php ENDPATH**/ ?>