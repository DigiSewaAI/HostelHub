...
<?php $__env->startSection('title', 'भुक्तानी सम्पादन गर्नुहोस्'); ?>

<?php $__env->startSection('content'); ?>
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 nepali">भुक्तानी सम्पादन गर्नुहोस्</h1>
            <a href="<?php echo e(route('payments.show', $payment)); ?>" class="text-indigo-600 hover:text-indigo-900 flex items-center nepali">
                    ...
                    <select name="student_id" id="student_id" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" required>
                        ...
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($student->id); ?>" <?php echo e($payment->student_id == $student->id ? 'selected' : ''); ?>>
                                <?php echo e($student->name); ?> (<?php echo e($student->room->room_number ?? 'N/A'); ?>)
                            </option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="amount" id="amount" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" 
                           required min="0" step="0.01" value="<?php echo e(old('amount', $payment->amount)); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="date" name="payment_date" id="payment_date" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" 
                           required value="<?php echo e(old('payment_date', $payment->payment_date->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="payment_method" id="payment_method" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" required>
                        <option value="cash" <?php echo e($payment->payment_method == 'cash' ? 'selected' : ''); ?> class="nepali">नगद</option>
                        <option value="bank_transfer" <?php echo e($payment->payment_method == 'bank_transfer' ? 'selected' : ''); ?> class="nepali">बैंक ट्रान्सफर</option>
                        <option value="online" <?php echo e($payment->payment_method == 'online' ? 'selected' : ''); ?> class="nepali">अनलाइन</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="3" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" 
                          placeholder="भुक्तानी सम्बन्धी थप जानकारी"><?php echo e(old('description', $payment->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <select name="status" id="status" class="w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500" required>
                    <option value="pending" <?php echo e($payment->status == 'pending' ? 'selected' : ''); ?> class="nepali">प्रतीक्षामा</option>
                    <option value="completed" <?php echo e($payment->status == 'completed' ? 'selected' : ''); ?> class="nepali">पूरा भएको</option>
                    <option value="failed" <?php echo e($payment->status == 'failed' ? 'selected' : ''); ?> class="nepali">असफल</option>
                </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views\admin\payments\edit.blade.php ENDPATH**/ ?>