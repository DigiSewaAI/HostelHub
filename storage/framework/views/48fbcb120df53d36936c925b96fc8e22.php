    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('admin.rooms.update', $room)); ?>" method="POST" enctype="multipart/form-data" id="roomForm">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\admin\rooms\edit.blade.php ENDPATH**/ ?>