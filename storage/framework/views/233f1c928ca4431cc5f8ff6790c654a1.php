...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <h2 class="text-xl font-semibold text-blue-700 mb-4"><?php echo e($student->name); ?></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p><strong>Guardian Contact:</strong> <?php echo e($student->guardian_contact); ?></p>
    ...
    <div class="mt-6 flex gap-4">
        <a href="<?php echo e(route('owner.students.edit', $student->id)); ?>"
           class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg shadow">
            ✏ सम्पादन गर्नुहोस्
        </a>
        <form action="<?php echo e(route('owner.students.destroy', $student->id)); ?>" method="POST" onsubmit="return confirm('के तपाईं पक्का delete गर्न चाहनुहुन्छ?')">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views/owner/students/show.blade.php ENDPATH**/ ?>