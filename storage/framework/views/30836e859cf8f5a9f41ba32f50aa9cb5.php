        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex gap-2">
                    ...
                    <a href="<?php echo e(route('gallery')); ?>" class="nav-button text-gray-700 hover:bg-indigo-100">ग्यालरी</a>
            ...
            <div class="mt-24 text-center">
                <div class="inline-block bg-white border border-gray-200 rounded-xl p-6 max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <a href="<?php echo e(route('register.organization')); ?>" class="inline-flex items-center justify-center px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-indigo-200">
                        ...
                        <li><a href="<?php echo e(route('gallery')); ?>" class="hover:text-white transition-colors">ग्यालरी</a></li>
                    </ul>
                </div>
                <div>
...
</html><?php /**PATH D:\My Projects\HostelHub\resources\views/frontend/partials/pricing/index.blade.php ENDPATH**/ ?>