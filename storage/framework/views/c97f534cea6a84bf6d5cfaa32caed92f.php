    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" 
            ...
            <div class="p-4 border-b border-blue-700 flex items-center justify-between">
                <a href="<?php echo e(url('/admin/dashboard')); ?>" class="logo-container">
            ...
            <nav class="mt-5 px-2 flex-1 overflow-y-auto">
                ...
                <!-- Meals -->
                <a href="<?php echo e(route('admin.meals.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.meals.*') ? 'active' : ''); ?>"
                   aria-current="<?php echo e(request()->routeIs('admin.meals.*') ? 'page' : 'false'); ?>">
                ...
                <a href="<?php echo e(route('admin.galleries.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.galleries.*') ? 'active' : ''); ?>"
                   aria-current="<?php echo e(request()->routeIs('admin.galleries.*') ? 'page' : 'false'); ?>">
                ...
                <a href="<?php echo e(route('admin.contacts.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.contacts.*') ? 'active' : ''); ?>"
                   aria-current="<?php echo e(request()->routeIs('admin.contacts.*') ? 'page' : 'false'); ?>">
                ...
                <a href="<?php echo e(route('admin.documents.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.documents.*') ? 'active' : ''); ?>"
                ...
                <!-- Circulars -->
                <a href="<?php echo e(route('admin.circulars.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.circulars.*') ? 'active' : ''); ?>"
                   aria-current="<?php echo e(request()->routeIs('admin.circulars.*') ? 'page' : 'false'); ?>">
            ...
            <header class="bg-gradient-primary shadow-sm z-10">
                <div class="flex items-center justify-between px-6 header-content">
                    <div class="flex items-center">
                        ...
                        <!-- Brand with Logo -->
                        <a href="<?php echo e(url('/admin/dashboard')); ?>" class="navbar-brand text-white flex items-center">
                        ...
                        <div class="d-flex align-items-center user-dropdown">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow dark:bg-gray-700">
                                    ...
                                    <li><a class="dropdown-item nepali dark:text-white dark:hover:bg-gray-600" href="<?php echo e(route('admin.settings.index')); ?>"><i class="fas fa-cog me-2"></i>सेटिङ्हरू</a></li>
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="mb-6">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <h1 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-1 md:block"><?php echo $__env->yieldContent('title'); ?></h1>
                                <?php if(View::hasSection('page-description')): ?>
                                    <p class="text-gray-600 dark:text-gray-300 text-sm"><?php echo $__env->yieldContent('page-description'); ?></p>
                                <?php endif; ?>
                            </div>
                            <div>
                    ...
                    <div class="main-content bg-white dark:bg-gray-700 rounded-xl shadow-sm overflow-hidden">
                        <?php if (! empty(trim($__env->yieldContent('विस्तार')))): ?>
                            <?php echo $__env->yieldContent('विस्तार'); ?>
                        <?php else: ?>
...
</html><?php /**PATH C:\laragon\www\HostelHub\resources\views\layouts\admin.blade.php ENDPATH**/ ?>