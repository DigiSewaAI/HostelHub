<?php $__env->startSection('title', 'Edit Hostel: ' . $hostel->name); ?>
        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-white py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Hostel: <?php echo e($hostel->name); ?></h6>
                </div>
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>"
                                   id="location" name="location" value="<?php echo e(old('location', $hostel->location)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                   id="total_rooms" name="total_rooms" value="<?php echo e(old('total_rooms', $hostel->total_rooms)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>" id="status" name="status">
                                <option value="active" <?php echo e(old('status', $hostel->status) == 'active' ? 'selected' : ''); ?>>Active</option>
                                <option value="maintenance" <?php echo e(old('status', $hostel->status) == 'maintenance' ? 'selected' : ''); ?>>Maintenance</option>
                                <option value="closed" <?php echo e(old('status', $hostel->status) == 'closed' ? 'selected' : ''); ?>>Closed</option>
                            </select>
