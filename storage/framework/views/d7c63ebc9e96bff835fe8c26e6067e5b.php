            ...
            <?php $__currentLoopData = $activeGalleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="gallery-item <?php echo e($isHidden ? 'hidden-item' : ''); ?>" 
                    ...
                    <?php if($isRoomAvailable): ?>
                        <a href="<?php echo e(route('contact')); ?>?room_type=<?php echo e($roomType); ?>&hostel=<?php echo e($hostel->slug); ?>" 
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views/public/hostels/full-gallery.blade.php ENDPATH**/ ?>