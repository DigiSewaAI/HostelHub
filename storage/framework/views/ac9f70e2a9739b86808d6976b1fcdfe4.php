...
<?php $__env->startSection('title', 'होस्टेल सीमाहरू'); ?>
...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('subscription.show')); ?>">सदस्यता</a></li>
    ...
    <div class="row">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p class="fs-5 text-primary"><?php echo e($subscription->plan->name); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label fw-bold">अनुमत होस्टेलहरू</label>
                                <p class="fs-5"><?php echo e($subscription->plan->max_hostels + $subscription->extra_hostels); ?></p>
                                <small class="text-muted">
                                    (मूल: <?php echo e($subscription->plan->max_hostels); ?> + अतिरिक्त: <?php echo e($subscription->extra_hostels); ?>)
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p class="fs-5"><?php echo e($hostelsCount); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p class="fs-5">
                                    <span class="badge <?php echo e($remainingSlots > 0 ? 'bg-success' : 'bg-danger'); ?> fs-6">
                    ...
                    <div class="alert alert-info">
                        ...
                        <p class="mb-0">तपाईंसँग अहिले <strong><?php echo e($remainingSlots); ?></strong> होस्टेल थप्ने स्लट उपलब्ध छ<?php echo e($remainingSlots > 1 ? 'न्' : ''); ?>।</p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <?php if($remainingSlots == 0 || $subscription->plan->slug === 'enterprise'): ?>
            <div class="card shadow">
                <div class="card-header bg-white py-3">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('subscription.purchase-extra-hostel')); ?>" method="POST" id="extraHostelForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="quantity" id="quantity" class="form-select" required>
                                ...
                                <?php for($i = 1; $i <= 10; $i++): ?>
                                <option value="<?php echo e($i); ?>"><?php echo e($i); ?> होस्टेल - रु. <?php echo e(number_format(1000 * $i)); ?>/महिना</option>
                                <?php endfor; ?>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views\subscription\limits.blade.php ENDPATH**/ ?>