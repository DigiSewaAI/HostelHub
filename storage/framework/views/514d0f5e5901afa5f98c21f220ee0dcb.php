...
<div class="bg-white rounded-2xl shadow-sm p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 nepali"><?php echo e($gallery->title); ?></h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
                        ...
                        <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-red-500 to-red-700">
                                <div class="text-center text-white">
                                    ...
                                    <a href="<?php echo e($gallery->external_link); ?>" target="_blank" 
                ...
                <?php elseif($gallery->media_type === 'video'): ?>
                    ...
                    <div class="aspect-video bg-black rounded-xl overflow-hidden">
                        <video controls class="w-full h-full rounded-lg">
                            <source src="<?php echo e($gallery->media_url); ?>" type="video/mp4">
            ...
            <div class="flex space-x-4">
                ...
                <form action="<?php echo e(route('owner.galleries.destroy', $gallery)); ?>" method="POST" class="flex-1" 
            ...
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center py-2 border-b border-gray-200">
                        ...
                        <span class="text-gray-900 nepali"><?php echo e($gallery->title); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between items-start py-2 border-b border-gray-200">
                        ...
                        <span class="text-gray-900 nepali text-right"><?php echo e($gallery->description ?: 'कुनै विवरण छैन'); ?></span>
                    </div>
            ...
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-200">
                        ...
                        <span class="text-gray-900 nepali"><?php echo e($gallery->created_at->format('Y-m-d')); ?></span>
                    </div>

                    <div class="flex justify-between items-center py-2">
                        <span class="text-gray-700 nepali font-medium">अद्यावधिक मिति:</span>
                        <span class="text-gray-900 nepali"><?php echo e($gallery->updated_at->format('Y-m-d')); ?></span>
                    </div>
                </div>
            </div>

            <!-- External Links (if applicable) -->
            <?php if($gallery->media_type === 'external_video' && $gallery->external_link): ?>
            <div class="bg-blue-50 p-6 rounded-xl border border-blue-200">
                <h2 class="text-lg font-semibold text-gray-800 mb-3 nepali">यूट्युब लिङ्क</h2>
                <a href="<?php echo e($gallery->external_link); ?>" 
                   target="_blank"
                   class="text-blue-600 hover:text-blue-800 break-words nepali">
                    <i class="fab fa-youtube mr-2 text-red-500"></i>
                    <?php echo e($gallery->external_link); ?>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\owner\galleries\show.blade.php ENDPATH**/ ?>