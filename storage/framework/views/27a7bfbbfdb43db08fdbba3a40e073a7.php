...
<style>
    :root {
        --theme-color: <?php echo e($hostel->theme_color ?? '#00D4FF'); ?>;
        --neon-cyan: #00D4FF;
        --neon-pink: #FF00FF;
        --neon-green: #00FF88;
        --neon-purple: #9D00FF;
...
<div class="dark-body">
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px; position: relative; z-index: 2;">
            ...
            <div class="cyber-container" style="margin-bottom: 2rem;">
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; padding: 1.5rem;">
                    ...
                    <a href="<?php echo e(route('owner.public-page.edit')); ?>" class="cyber-btn btn-cyber-pink">
            ...
            <div style="text-align: center; margin-bottom: 2rem;">
                ...
                <h1 class="cyber-title nepali-font"><?php echo e($hostel->name); ?></h1>
                <p class="cyber-subtitle nepali-font">
                    <?php if($hostel->city): ?>
                    <i class="fas fa-map-marker-alt" style="color: var(--neon-cyan); margin-right: 0.5rem;"></i><?php echo e($hostel->city); ?>
            ...
            <div class="cyber-stats">
                <div class="cyber-stat">
                    <span class="cyber-number"><?php echo e($hostel->total_rooms ?? 0); ?></span>
                    <span class="cyber-label nepali-font">कुल कोठा</span>
                </div>
                <div class="cyber-stat">
                    <span class="cyber-number"><?php echo e($hostel->available_rooms ?? 0); ?></span>
                    <span class="cyber-label nepali-font">उपलब्ध कोठा</span>
                </div>
                <div class="cyber-stat">
                    <span class="cyber-number"><?php echo e($studentCount); ?></span>
                    <span class="cyber-label nepali-font">विद्यार्थी</span>
                </div>
                <div class="cyber-stat">
                    <span class="cyber-number"><?php echo e($reviewCount); ?></span>
            ...
            <div class="cyber-social">
                <?php if($hostel->facebook_url): ?>
                    <a href="<?php echo e($hostel->facebook_url); ?>" target="_blank" class="cyber-social-icon">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                <?php endif; ?>
                <?php if($hostel->instagram_url): ?>
                    <a href="<?php echo e($hostel->instagram_url); ?>" target="_blank" class="cyber-social-icon">
                        <i class="fab fa-instagram"></i>
                    </a>
                <?php endif; ?>
                <?php if($hostel->whatsapp_number): ?>
                    <a href="https://wa.me/<?php echo e($hostel->whatsapp_number); ?>" target="_blank" class="cyber-social-icon">
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        ...
        <div class="cyber-action-buttons">
            ...
            <a href="tel:<?php echo e($hostel->contact_phone); ?>" class="cyber-btn btn-cyber-green">
                <i class="fas fa-phone"></i>
                <span class="nepali-font">फोन गर्नुहोस्</span>
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('hostels.index')); ?>" class="cyber-btn">
                    ...
                    <div class="cyber-gallery-item group">
                        ...
                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-70 transition-all duration-300 flex items-center justify-center p-4">
                            <div class="text-white text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                <h4 class="font-semibold text-sm mb-1 nepali-font"><?php echo e($gallery->title); ?></h4>
                                <?php if($gallery->description): ?>
                                    <p class="text-xs opacity-90 nepali-font"><?php echo e(Str::limit($gallery->description, 60)); ?></p>
                                <?php endif; ?>
            ...
            <div class="cyber-facilities">
                <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="cyber-facility">
                        ...
                        <span class="nepali-font" style="color: var(--text-primary); font-weight: 500; font-size: 1.1rem;"><?php echo e(trim($facility)); ?></span>
                    </div>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: start;">
                    <div>
                        ...
                        <?php if($hostel->address): ?>
                            <p style="color: var(--text-secondary); line-height: 1.8; margin-bottom: 2rem; font-size: 1.1rem;" class="nepali-font"><?php echo e($hostel->address); ?></p>
                        <?php endif; ?>
                    ...
                    <div class="cyber-reviews-track" id="cyberReviewsTrack">
                        ...
                        <div class="cyber-review">
                            <div class="cyber-review-header">
                                <div class="cyber-reviewer nepali-font"><?php echo e($review->student->user->name ?? 'अज्ञात विद्यार्थी'); ?></div>
                                <div class="cyber-review-date"><?php echo e($review->created_at->format('Y-m-d')); ?></div>
                            </div>
                            <div class="cyber-review-rating">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <i class="fas fa-star <?php echo e($i <= $review->rating ? '' : 'far'); ?>"></i>
                                <?php endfor; ?>
                                <span style="margin-left: 1rem; color: var(--neon-orange); font-weight: 700;"><?php echo e($review->rating); ?>/5</span>
                            </div>
                            <div class="cyber-review-content nepali-font"><?php echo e($review->comment); ?></div>
                            ...
                            <div style="background: rgba(157, 0, 255, 0.1); border-left: 4px solid var(--neon-purple); padding: 1.5rem; margin-top: 1.5rem;">
                                <div style="display: flex; align-items: start; gap: 1rem;">
                                    ...
                                    <div>
                                        ...
                                        <p style="color: var(--text-secondary); margin-top: 0.8rem; font-size: 1rem;" class="nepali-font"><?php echo e($review->reply); ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
        ...
        <section class="cyber-container">
            ...
            <div class="cyber-contact-grid">
                ...
                <div class="cyber-contact-card">
                    ...
                    <p style="color: var(--text-secondary); font-weight: 500; font-size: 1.1rem;"><?php echo e($hostel->contact_person); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="cyber-contact-card">
                    ...
                    <a href="tel:<?php echo e($hostel->contact_phone); ?>" style="color: var(--text-secondary); font-weight: 500; font-size: 1.1rem; text-decoration: none;">
                ...
                <div class="cyber-contact-card">
                    ...
                    <a href="mailto:<?php echo e($hostel->contact_email); ?>" style="color: var(--text-secondary); font-weight: 500; font-size: 1.1rem; text-decoration: none;">
                ...
                <div class="cyber-contact-card">
                    ...
                    <p style="color: var(--text-secondary); font-weight: 500; font-size: 1.1rem;" class="nepali-font"><?php echo e($hostel->address); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </section>
...
<!-- Cyber Phone Button -->
<?php if($hostel->contact_phone): ?>
    <a href="tel:<?php echo e($hostel->contact_phone); ?>" class="cyber-phone-btn" aria-label="फोन गर्नुहोस्">
        <i class="fas fa-phone"></i>
    </a>
<?php endif; ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\public\hostels\themes\dark.blade.php ENDPATH**/ ?>