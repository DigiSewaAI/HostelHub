<?php $__env->startSection('title', $hostel->name . ' - सम्पादन'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><?php echo e($hostel->name); ?> - सम्पादन</h5>
                    <a href="<?php echo e(route('owner.hostels.index')); ?>" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> होस्टल सूची
                    </a>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(url('/owner/hostels/' . $hostel->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('contact_person', $hostel->contact_person)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('contact_phone', $hostel->contact_phone)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('contact_email', $hostel->contact_email)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="address" name="address" value="<?php echo e(old('address', $hostel->address)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status">
                                        <option value="active" <?php echo e($hostel->status == 'active' ? 'selected' : ''); ?>>सक्रिय</option>
                                        <option value="inactive" <?php echo e($hostel->status == 'inactive' ? 'selected' : ''); ?>>निष्क्रिय</option>
                                    </select>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['facilities'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('facilities', $hostel->facilities ? implode(', ', json_decode($hostel->facilities)) : '')); ?>"
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control <?php $__errorArgs = ['monthly_rent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('monthly_rent', $hostel->monthly_rent)); ?>" required min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('security_deposit', $hostel->security_deposit)); ?>" required min="0">
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views/owner/hostels/edit.blade.php ENDPATH**/ ?>