        ...
        roomDetailsModal.addEventListener('show.bs.modal', function (event) {
            ...
            if (roomStatus === 'available') {
                ...
                bookBtn.onclick = function() {
                    window.location.href = "<?php echo e(route('student.bookings.create')); ?>?room_id=" + roomId;
                };
            } else {
...
</script><?php /**PATH D:\My Projects\HostelHub\resources\views\student\modals\room-details.blade.php ENDPATH**/ ?>