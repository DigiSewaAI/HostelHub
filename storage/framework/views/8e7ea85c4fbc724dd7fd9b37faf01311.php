<?php $__env->startSection('title', 'ग्यालेरी विवरण'); ?>
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        <?php if($gallery->media_type === 'photo' && $gallery->file_path): ?>
            <img src="<?php echo e(asset('storage/'.$gallery->file_path)); ?>" alt="<?php echo e($gallery->title); ?>" class="mb-4 max-w-full">
        <?php elseif($gallery->media_type === 'local_video' && $gallery->file_path): ?>
        ...
        <?php elseif($gallery->media_type === 'external_video' && $gallery->external_link): ?>
            ...
            ?>
            <?php if($youtubeId): ?>
                <iframe src="https://www.youtube.com/embed/<?php echo e($youtubeId); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views\admin\galleries\show.blade.php ENDPATH**/ ?>