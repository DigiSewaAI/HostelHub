...
<div class="grid gap-6">
    ...
    <div class="form-group">
        ...
        <select name="hostel_id" id="hostel_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <?php $__currentLoopData = $hostels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($id); ?>" <?php echo e(old('hostel_id', isset($gallery) ? $gallery->hostel_id : '') == $id ? 'selected' : ''); ?>>
                    <?php echo e($name); ?>
    ...
    <div class="form-group">
        ...
        <select name="media_type" id="media_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            <option value="photo" <?php echo e(old('media_type', $gallery->media_type ?? 'photo') == 'photo' ? 'selected' : ''); ?>>तस्वीर</option>
            <option value="external_video" <?php echo e(old('media_type', $gallery->media_type ?? '') == 'external_video' ? 'selected' : ''); ?>>बाह्य भिडियो (YouTube/Vimeo)</option>
            <option value="local_video" <?php echo e(old('media_type', $gallery->media_type ?? '') == 'local_video' ? 'selected' : ''); ?>>स्थानीय भिडियो अपलोड</option>
        </select>
    </div>

    <!-- Multiple File Upload Field -->
    <div class="form-group" id="multiple-media-field" style="<?php echo e(old('media_type', $gallery->media_type ?? 'photo') == 'photo' ? '' : 'display:none;'); ?>">
        ...
        <?php if(isset($gallery) && $gallery->media_type == 'photo' && $gallery->file_path): ?>
            <div class="mt-2">
                <img src="<?php echo e(asset('storage/' . $gallery->file_path)); ?>" alt="हालको तस्वीर" class="max-h-40 rounded">
    ...
    <div class="form-group" id="external-link-field" style="<?php echo e(old('media_type', $gallery->media_type ?? '') == 'external_video' ? '' : 'display:none;'); ?>">
        ...
        <?php if(isset($gallery) && $gallery->media_type == 'external_video' && $gallery->external_link): ?>
            ...
            <?php if($youtubeId): ?>
            <div class="mt-2">
                <img src="https://img.youtube.com/vi/<?php echo e($youtubeId); ?>/mqdefault.jpg" alt="YouTube थम्बनेल" class="max-h-40 rounded">
    ...
    <div class="form-group">
        ...
        <select name="category" id="category" 
            ...
            <option value="video" <?php echo e(old('category', $gallery->category ?? '') == 'video' ? 'selected' : ''); ?>>भिडियो टुर</option>
            <option value="1 seater" <?php echo e(old('category', $gallery->category ?? '') == '1 seater' ? 'selected' : ''); ?>>१ सिटर कोठा</option>
            <option value="2 seater" <?php echo e(old('category', $gallery->category ?? '') == '2 seater' ? 'selected' : ''); ?>>२ सिटर कोठा</option>
            <option value="3 seater" <?php echo e(old('category', $gallery->category ?? '') == '3 seater' ? 'selected' : ''); ?>>३ सिटर कोठा</option>
            <option value="4 seater" <?php echo e(old('category', $gallery->category ?? '') == '4 seater' ? 'selected' : ''); ?>>४ सिटर कोठा</option>
            <option value="common" <?php echo e(old('category', $gallery->category ?? '') == 'common' ? 'selected' : ''); ?>>सामान्य क्षेत्र</option>
            <option value="kitchen" <?php echo e(old('category', $gallery->category ?? '') == 'kitchen' ? 'selected' : ''); ?>>भान्सा</option>
            <option value="bathroom" <?php echo e(old('category', $gallery->category ?? '') == 'bathroom' ? 'selected' : ''); ?>>बाथरूम</option>
            <option value="study room" <?php echo e(old('category', $gallery->category ?? '') == 'study room' ? 'selected' : ''); ?>>अध्ययन कोठा</option>
            <option value="event" <?php echo e(old('category', $gallery->category ?? '') == 'event' ? 'selected' : ''); ?>>कार्यक्रम तस्वीरहरू</option>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <select name="status" id="status" 
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" 
                required>
            <option value="active" <?php echo e(old('status', isset($gallery) ? ($gallery->is_active ? 'active' : 'inactive') : 'active') == 'active' ? 'selected' : ''); ?>>सक्रिय</option>
            <option value="inactive" <?php echo e(old('status', isset($gallery) ? ($gallery->is_active ? 'active' : 'inactive') : 'active') == 'inactive' ? 'selected' : ''); ?>>निष्क्रिय</option>
        </select>
    </div>
...
</script><?php /**PATH D:\My Projects\HostelHub\resources\views/admin/galleries/_form.blade.php ENDPATH**/ ?>