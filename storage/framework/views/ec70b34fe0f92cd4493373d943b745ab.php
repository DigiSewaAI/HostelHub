...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="1_seater" <?php echo e(old('gallery_category') == '1_seater' ? 'selected' : ''); ?>>१ सिटर कोठा</option>
                                <option value="2_seater" <?php echo e(old('gallery_category') == '2_seater' ? 'selected' : ''); ?>>२ सिटर कोठा</option>
                                <option value="3_seater" <?php echo e(old('gallery_category') == '3_seater' ? 'selected' : ''); ?>>३ सिटर कोठा</option>
                                <option value="4_seater" <?php echo e(old('gallery_category') == '4_seater' ? 'selected' : ''); ?>>४ सिटर कोठा</option>
                                <option value="living_room" <?php echo e(old('gallery_category') == 'living_room' ? 'selected' : ''); ?>>लिभिङ रूम</option>
                                <option value="bathroom" <?php echo e(old('gallery_category') == 'bathroom' ? 'selected' : ''); ?>>बाथरूम</option>
                                <option value="kitchen" <?php echo e(old('gallery_category') == 'kitchen' ? 'selected' : ''); ?>>भान्सा</option>
                                <option value="study_room" <?php echo e(old('gallery_category') == 'study_room' ? 'selected' : ''); ?>>अध्ययन कोठा</option>
                                <option value="events" <?php echo e(old('gallery_category') == 'events' ? 'selected' : ''); ?>>कार्यक्रम</option>
                                <option value="video_tour" <?php echo e(old('gallery_category') == 'video_tour' ? 'selected' : ''); ?>>भिडियो टुर</option>
                            </select>
