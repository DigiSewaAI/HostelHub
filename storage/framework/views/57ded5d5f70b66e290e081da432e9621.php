...
<?php $__env->startSection('title', 'नयाँ होस्टल थप्नुहोस्'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('owner.hostels.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="total_rooms" name="total_rooms" value="<?php echo e(old('total_rooms', 1)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="available_rooms" name="available_rooms" value="<?php echo e(old('available_rooms', 1)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>"
                                      id="facilities" name="facilities" rows="2" placeholder="WiFi, Laundry, Hot Water, CCTV"><?php echo e(old('facilities')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <a href="<?php echo e(route('owner.hostels.index')); ?>" class="btn btn-secondary me-md-2">
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views/owner/hostels/create.blade.php ENDPATH**/ ?>