    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar bg-blue-800 text-white z-20 flex-shrink-0 transition-all duration-300 ease-in-out">
            ...
            <nav class="mt-5 px-2">
                ...
                <!-- Meals -->
                <?php if(Route::has('admin.meals.index')): ?>
                ...
                <?php if(Route::has('admin.gallery.index')): ?>
                    <a href="<?php echo e(route('admin.gallery.index')); ?>"
                       class="sidebar-link <?php echo e(request()->routeIs('admin.gallery.*') ? 'active' : ''); ?>"
                       aria-current="<?php echo e(request()->routeIs('admin.gallery.*') ? 'page' : 'false'); ?>">
                ...
                <!-- Contacts -->
                <?php if(Route::has('admin.contacts.index')): ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <nav class="hidden md:flex" aria-label="Breadcrumb">
                            <ol class="flex items-center space-x-2 text-sm">
                                ...
                                <?php elseif(Route::has('admin.hostels.index') && request()->routeIs('admin.hostels.*')): ?>
                                    <li class="text-gray-500">
                                        <i class="fas fa-chevron-right text-xs mx-2"></i>
                                        <a href="<?php echo e(route('admin.hostels.index')); ?>" class="hover:text-indigo-600">होस्टलहरू</a>
                                    </li>
                                    <?php if(Route::has('admin.hostels.create') && request()->routeIs('admin.hostels.create')): ?>
                                        <li class="text-gray-500">
                                            <i class="fas fa-chevron-right text-xs mx-2"></i>
                                            <span>थप्नुहोस्</span>
                                        </li>
                                    <?php elseif(Route::has('admin.hostels.edit') && request()->routeIs('admin.hostels.edit')): ?>
                                        <li class="text-gray-500">
                                            <i class="fas fa-chevron-right text-xs mx-2"></i>
                                            <span>सम्पादन गर्नुहोस्</span>
                                        </li>
                                    <?php endif; ?>
                                <?php elseif(Route::has('admin.rooms.index') && request()->routeIs('admin.rooms.*')): ?>
                                    <li class="text-gray-500">
                                        <i class="fas fa-chevron-right text-xs mx-2"></i>
                                        <a href="<?php echo e(route('admin.rooms.index')); ?>" class="hover:text-indigo-600">कोठाहरू</a>
                                    </li>
                                <?php elseif(Route::has('admin.students.index') && request()->routeIs('admin.students.*')): ?>
                                    <li class="text-gray-500">
                                        <i class="fas fa-chevron-right text-xs mx-2"></i>
                                        <a href="<?php echo e(route('admin.students.index')); ?>" class="hover:text-indigo-600">विद्यार्थीहरू</a>
                                    </li>
                                <?php elseif(Route::has('admin.gallery.index') && request()->routeIs('admin.gallery.*')): ?>
                                    <li class="text-gray-500">
                                        <i class="fas fa-chevron-right text-xs mx-2"></i>
                                        <a href="<?php echo e(route('admin.gallery.index')); ?>" class="hover:text-indigo-600">ग्यालरी</a>
                                    </li>
                                <?php endif; ?>
                            </ol>
                        </nav>
...
<?php /**PATH D:\My Projects\HostelHub\resources\views/layouts/app.blade.php ENDPATH**/ ?>