...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-8 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-xl font-bold text-indigo-800"><?php echo e($plan->name ?? 'योजना'); ?></h3>
                            <p class="text-indigo-700 text-lg font-semibold mt-1">
                                मूल्य: रु. <?php echo e(number_format($plan->price ?? 0)); ?>/महिना
                            </p>
                        </div>
                ...
                <div class="mb-6">
                    <label class="flex items-start space-x-2">
                        ...
                        <span class="text-sm text-gray-600">
                            म <a href="<?php echo e(route('terms')); ?>" class="text-indigo-600 hover:underline">सेवा सर्तहरू</a> 
                            र <a href="<?php echo e(route('privacy')); ?>" class="text-indigo-600 hover:underline">गोप्यता नीति</a> 
                            सहमत छु
                        </span>
                    </label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-8 text-center border-t pt-6">
                <p class="text-gray-600">
                    पहिले नै खाता छ? 
                    <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 hover:underline font-semibold">लगइन गर्नुहोस्</a>
                </p>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HostelHub\resources\views\auth\organization\register.blade.php ENDPATH**/ ?>