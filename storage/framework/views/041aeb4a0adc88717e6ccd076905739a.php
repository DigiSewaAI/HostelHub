...
unset($__errorArgs, $__bag); ?>" id="key" name="key" value="<?php echo e(old('key', $setting->key)); ?>" required>
                            <?php $__errorArgs = ['key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="group" name="group" value="<?php echo e(old('group', $setting->group)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                                ...
                                <option value="select" <?php echo e(old('type', $setting->type) == 'select' ? 'selected' : ''); ?>>Select</option>
                                <option value="boolean" <?php echo e(old('type', $setting->type) == 'boolean' ? 'selected' : ''); ?>>Boolean</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 <?php echo e($setting->type != 'select' ? 'd-none' : ''); ?>" id="options-field">
...
unset($__errorArgs, $__bag); ?>" id="options" name="options" rows="3"><?php echo e(old('options', $setting->options)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Projects\HostelHub\resources\views\admin\settings\edit.blade.php ENDPATH**/ ?>