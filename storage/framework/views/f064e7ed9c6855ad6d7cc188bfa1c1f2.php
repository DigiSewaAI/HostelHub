    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="stat-card bg-gradient-to-r from-blue-50 to-blue-100 border-l-4 border-blue-500 p-5 rounded-lg shadow-sm card-hover">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2 text-gray-900"><?php echo e($metrics['total_hostels']); ?></p>
                    </div>
            ...
            <div class="stat-card bg-gradient-to-r from-green-50 to-green-100 border-l-4 border-green-500 p-5 rounded-lg shadow-sm card-hover">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2 text-gray-900"><?php echo e($metrics['total_rooms']); ?></p>
                    </div>
            ...
            <div class="stat-card bg-gradient-to-r from-amber-50 to-amber-100 border-l-4 border-amber-500 p-5 rounded-lg shadow-sm card-hover">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2 text-gray-900"><?php echo e($metrics['total_students']); ?></p>
                    </div>
            ...
            <div class="stat-card bg-gradient-to-r from-red-50 to-red-100 border-l-4 border-red-500 p-5 rounded-lg shadow-sm card-hover">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2 text-gray-900"><?php echo e($metrics['total_contacts']); ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div class="bg-blue-50 p-4 rounded-lg text-center">
                <div class="text-blue-600 text-2xl font-bold"><?php echo e($metrics['available_rooms']); ?></div>
                <div class="text-sm text-blue-800">उपलब्ध कोठाहरू</div>
            </div>
            <div class="bg-green-50 p-4 rounded-lg text-center">
                <div class="text-green-600 text-2xl font-bold"><?php echo e($metrics['occupied_rooms']); ?></div>
                <div class="text-sm text-green-800">अधिभृत कोठाहरू</div>
            </div>
            <div class="bg-amber-50 p-4 rounded-lg text-center">
                <div class="text-amber-600 text-2xl font-bold"><?php echo e($metrics['reserved_rooms']); ?></div>
                <div class="text-sm text-amber-800">आरक्षित कोठाहरू</div>
            </div>
            <div class="bg-red-50 p-4 rounded-lg text-center">
                <div class="text-red-600 text-2xl font-bold"><?php echo e($metrics['maintenance_rooms']); ?></div>
                    ...
                    <div class="flex items-start mb-6">
                        ...
                        <div class="ml-6">
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                <?php echo e($student->name); ?> (<?php echo e($student->room->hostel->name ?? 'अज्ञात होस्टल'); ?>)
                            </p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="<?php echo e(route('admin.students.create')); ?>" class="p-4 bg-blue-50 hover:bg-blue-100 rounded-lg text-center transition-colors">
                ...
                <a href="<?php echo e(route('admin.rooms.create')); ?>" class="p-4 bg-green-50 hover:bg-green-100 rounded-lg text-center transition-colors">
                ...
                <a href="<?php echo e(route('admin.hostels.create')); ?>" class="p-4 bg-amber-50 hover:bg-amber-100 rounded-lg text-center transition-colors">
                ...
                <a href="<?php echo e(route('admin.reports')); ?>" class="p-4 bg-purple-50 hover:bg-purple-100 rounded-lg text-center transition-colors">
