            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-bullhorn mr-2"></i>सबै सूचनाहरू
                    </h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.circulars.create') }}" class="btn btn-light btn-sm">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead class="bg-light">
                                <tr>
                                    <th width="5%">#</th>
                                    <th width="25%">शीर्षक</th>
                                    <th width="15%">संस्था</th>
                                    <th width="10%">प्राथमिकता</th>
                                    <th width="10%">लक्षित प्रयोगकर्ता</th>
                                ...
                                @forelse($circulars as $circular)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="text-muted">ग्लोबल</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <a href="{{ route('admin.circulars.analytics.single', $circular) }}" 
...
@endsection ?><?php /**PATH D:\My Projects\HostelHub\resources\views\admin\circulars\index.blade.php ENDPATH**/ ?>